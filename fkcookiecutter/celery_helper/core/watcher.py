...
class TaskWatcher:
    ...
    def send_dd_robot(
        ...
        api_path = '{host}/{api}'.format(
            host=os.environ.get('DD_ROBOT_WEBHOOK_HOST'),
            api=os.environ.get('DD_ROBOT_WEBHOOK_API'),
        )
        ...
        try:
            ...
            data = dict(
                ...
                project_name=app_name or os.environ.get('APP_NAME'),
                ...
                webhook_url=os.environ.get('DD_ROBOT_WEBHOOK_URL'),
                access_token=os.environ.get('DD_ROBOT_WEBHOOK_ACCESS_TOKEN'),
                secret=os.environ.get('DD_ROBOT_WEBHOOK_SECRET'),
            )
